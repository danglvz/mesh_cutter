...
mesh - реализация координатной сетка, поддерживающей разрезание плоскостью
...
//инициализация разрезающе плоскости
...
//так и по нормали и расстоянию о точки начала координат
base_entities::Plane clipp_plane = base_entities::Plane(base_entities::Vec3d(x,y,z),
							scalar);
